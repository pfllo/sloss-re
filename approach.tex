...
Concretely, for each sub-category of constraint sets $\bm{C}^{\phi}$($\phi \in \bm{\Phi}$), our semantic loss for the combination of $i^{th}$ and $j^{th}$ entity pairs in a batch is defined as:
